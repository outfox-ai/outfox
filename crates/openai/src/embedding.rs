...
use crate::spec::EncodingFormat;
use crate::spec::{CreateBase64EmbeddingResponse, CreateEmbeddingRequest, CreateEmbeddingResponse};
...
mod tests {
    ...
    use crate::spec::embeddings::{
        CreateEmbeddingRequestArgs, CreateEmbeddingResponse, Embedding, EncodingFormat,
    };
