...
impl<'c, C: Config> Uploads<'c, C> {
    ...
    /// documentation on [creating a File](https://platform.openai.com/docs/api-reference/files/create).
    ...
    /// Parts when you [complete the Upload](https://platform.openai.com/docs/api-reference/uploads/complete).
    #[crate::byot(
        T0 = std::fmt::Display,
        T1 = Clone,
