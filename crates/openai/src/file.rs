...
use crate::spec::files::{CreateFileRequest, DeleteFileResponse, ListFilesResponse, OpenAIFile};
...
mod tests {
    ...
    use crate::traits::RequestOptionsBuilder;
    ...
    async fn test_file_mod() {
        ...
        // "To help mitigate abuse, downloading of fine-tune training files is disabled for free
        // accounts." let retrieved_contents =
        // client.files().retrieve_content(&openai_file.id) .await
        // .unwrap();
        //
