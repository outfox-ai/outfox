...
use crate::spec::admin::certificates::{ListCertificatesResponse, ToggleCertificatesRequest};
use crate::{Client, RequestOptions};

/// Manage certificates for a given project. Supports listing, activating, and deactivating
/// certificates.
