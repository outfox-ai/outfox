...
use crate::spec::admin::project_service_accounts::{
    ProjectServiceAccount, ProjectServiceAccountCreateRequest, ProjectServiceAccountCreateResponse,
...
impl<'c, C: Config> ProjectServiceAccounts<'c, C> {
    ...
    /// Creates a new service account in the project. This also returns an unredacted API key for
    /// the service account.
