...
use crate::spec::vectorstores::{
    CreateVectorStoreFileRequest, DeleteVectorStoreFileResponse, ListVectorStoreFilesResponse,
    UpdateVectorStoreFileAttributesRequest, VectorStoreFileContentResponse, VectorStoreFileObject,
};
...
mod tests {
    use crate::Client;
    use crate::spec::files::{CreateFileRequest, FileInput, FilePurpose};
    use crate::spec::vectorstores::CreateVectorStoreRequest;
