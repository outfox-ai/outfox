...
use crate::spec::batches::ResponseUsage;
...
pub struct BatchFileExpirationAfter {
    ...
    /// The number of seconds after the anchor time that the file will expire. Must be between 3600
...
pub struct Batch {
    ...
    /// tokens, and the total tokens used. Only populated on batches created after September 7,
    /// 2025.
