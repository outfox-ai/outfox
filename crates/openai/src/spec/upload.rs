...
#[builder(name = "CreateUploadRequestBuilder")]
...
pub struct Upload {
    ...
    /// The intended purpose of the file. [Please refer here]([Please refer here](/docs/api-reference/files/object#files/object-purpose) for acceptable values.)
    pub purpose: UploadPurpose,
