...
use super::CreateMessageRequestContent;
...
use super::{AudioInput, FileInput, ImageInput};
#[cfg(any(feature = "chat-completion-types", feature = "completion-types"))]
use super::{ChatCompletionToolChoiceOption, StopConfiguration};
#[cfg(any(
    feature = "audio-types",
    feature = "file-types",
    feature = "image-types",
...
// Note: Display impls for ImageSize, DallE2ImageSize, ImageModel, ImageResponseFormat
// are in spec/images/impls.rs

// Note: Display impls for AudioResponseFormat, TimestampGranularity
// are in spec/audio/impls.rs

// Note: Display impl for Role is in spec/chat/impls.rs

// Note: Display impl for FilePurpose is in spec/files/impls.rs

// Note: ImagesResponse::save and Image::save implementations are in spec/images/sdk.rs
// Note: CreateSpeechResponse::save implementation is in spec/audio/sdk.rs
...
// Note: From impls for ChatCompletionFunctionCall, FunctionName, ChatCompletionNamedToolChoice
// are in spec/chat/impls.rs
...
// Note: From<PartibleTextContent> impls for messages removed due to type mismatch.
// The content fields expect specific *MessageContent types, not PartibleTextContent.
// Use the appropriate content type constructors instead.
