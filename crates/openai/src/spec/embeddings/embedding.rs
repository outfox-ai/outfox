...
pub struct CreateEmbeddingRequest {
    ...
    /// single request, pass an array of strings or array of token arrays. The input must not
    ...
    /// Python code](https://cookbook.openai.com/examples/how_to_count_tokens_with_tiktoken) for counting tokens.
    /// In addition to the per-input token limit, all embedding  models enforce a maximum of
