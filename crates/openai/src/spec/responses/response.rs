...
use crate::spec::mcp::{MCPListToolsTool, MCPTool};
...
pub enum Item {
    ...
    /// given with the user role. OutputMessage:
...
/// 2. `Item` - Structured items with proper type discrimination (including InputMessage,
///    OutputMessage, tool calls)
...
pub struct ItemReference {
    ...
    pub kind: Option<ItemReferenceType>,
...
pub struct ComputerScreenshotImage {
    ...
    pub kind: ComputerScreenshotImageType,
...
/// the `assistant` role (use OutputMessage for that). status is populated when items are returned
/// via API.
#[derive(Debug, Serialize, Deserialize, Clone, PartialEq, Default, Builder)]
#[builder(
...
pub struct CreateResponse {
    ...
    /// - If set to '[flex](https://platform.openai.com/docs/guides/flex-processing)' or '[priority](https://openai.com/api-priority-processing/)',
    ...
    ///   connectors such as Google Drive and SharePoint. Learn more about [MCP Tools](https://platform.openai.com/docs/guides/tools-connectors-mcp).
...
pub struct WebSearchApproximateLocation {
    ...
    pub kind: WebSearchApproximateLocationType,
