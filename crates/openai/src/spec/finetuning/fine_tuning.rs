...
pub struct FineTuningIntegration {
    ...
    /// supported.
    pub kind: FineTuningJobIntegrationType,
    ...
    /// for your run, add tags to your run, and set a default entity (team, username, etc) to
...
pub struct WandB {
    ...
    /// user that you would like associated with the run. If not set, the default entity for
...
pub struct FineTuningJobEvent {
    ...
    pub object: String,
    /// The type of event.
    pub kind: Option<FineTuningJobEventType>,
