...
use crate::spec::audio::{LogProbProperties, TranscriptTextUsageTokens};
...
pub enum CreateTranscriptionResponseStreamEvent {
    ...
    /// Only emitted when you [create a transcription](https://platform.openai.com/docs/api-reference/audio/create-transcription) with
    ...
    /// emitted when you [create a transcription](https://platform.openai.com/docs/api-reference/audio/create-transcription) with the
