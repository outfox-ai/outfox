...
use crate::spec::text::TextObject;
...
impl From<TextObject> for ChatCompletionRequestUserMessageContentPart {
    ...
    for ChatCompletionRequestUserMessageContentPart
{
    fn from(value: ChatCompletionRequestMessageContentPartText) -> Self {
        ChatCompletionRequestUserMessageContentPart::Text(TextObject { text: value.text })
    }
}
...
// Note: ChatCompletionTools enum with Function/Custom variants not implemented.
// These From impls were removed because the target types don't exist.
...
// Note: ChatCompletionMessageToolCalls enum with Function/Custom variants not implemented.
// These From impls were removed because the target types don't exist.
